...
if TRAIN_RATIO + VAL_RATIO + TEST_RATIO != 100:
    ...
    raise ValueError("训练集+验证集+测试集概率错误")
...
def convert_annotation(image_id):
    print(image_id)
    in_file = open('custom_dataset/VOC2007/Annotations/%s.xml' %image_id, encoding='utf-8')
    out_file = open('custom_dataset/VOC2007/YOLOLabels/%s.txt' %image_id, 'w', encoding='utf-8')
...
wd = os.getcwd()
wd = os.getcwd()
data_base_dir = os.path.join(wd, "custom_dataset/")
...
train_file = open(os.path.join(wd, "yolov6_train.txt"), 'w', encoding='utf-8')
test_file = open(os.path.join(wd, "yolov6_test.txt"), 'w', encoding='utf-8')
val_file = open(os.path.join(wd, "yolov6_val.txt"), 'w', encoding='utf-8')
train_file.close()
test_file.close()
val_file.close()
train_file = open(os.path.join(wd, "yolov6_train.txt"), 'a', encoding='utf-8')
val_file = open(os.path.join(wd, "yolov6_val.txt"), 'a', encoding='utf-8')
test_file = open(os.path.join(wd, "yolov6_test.txt"), 'a', encoding='utf-8')
